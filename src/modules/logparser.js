  ...
  try {
    ...
    while (i < bin.length) {
      ...
      if (tWithoutId === REC_TYPE.IMU) {
        let [accX, accY, accZ, gyroX, gyroY, gyroZ] = [
          bin.readInt16LE(i),
          bin.readInt16LE(i + 2),
          bin.readInt16LE(i + 4),
          bin.readInt16LE(i + 6),
          bin.readInt16LE(i + 8),
          bin.readInt16LE(i + 10),
        ];
        imu.push({
          ts: ts,
          id: `IMU${sensorId}`,
        ...
        let [height, velocity, acceleration] = [
          bin.readFloatLE(i),
          bin.readFloatLE(i + 4),
          bin.readFloatLE(i + 8),
        ];
        ...
        let [filteredAltitudeAGL, filteredAcceleration] = [
          bin.readFloatLE(i),
          bin.readFloatLE(i + 4),
        ];
        ...
        let [event, action, argument] = [
          bin.readUint32LE(i),
          bin.readUint16LE(i + 4),
          bin.readUint16LE(i + 6),
        ];
        eventInfo.push({
          ts: ts,
          event: event,
        ...
        let [latitude, longitude, satellites] = [
          bin.readFloatLE(i),
          bin.readFloatLE(i + 4),
          bin.readUInt8(i + 8),
        ];
