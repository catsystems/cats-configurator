...
export const LOG_ELEMENTS = [
  { name: "IMU", dec: 16, hex: 0x10, size: 20, bit: 4 },
  { name: "Barometer", dec: 32, hex: 0x20, size: 16, bit: 5 },
  { name: "Flight Info", dec: 64, hex: 0x40, size: 20, bit: 6 },
  { name: "Orientation", dec: 128, hex: 0x80, size: 16, bit: 7 },
  { name: "Filtered Data", dec: 256, hex: 0x100, size: 16, bit: 8 },
  { name: "Flight State", dec: 512, hex: 0x200, size: 12, bit: 9 },
  { name: "Event Info", dec: 1024, hex: 0x400, size: 16, bit: 10 },
  { name: "Error Info", dec: 2048, hex: 0x800, size: 12, bit: 11 },
  { name: "GNSS", dec: 4096, hex: 0x1000, size: 17, bit: 12 },
  { name: "Voltage", dec: 8192, hex: 0x2000, size: 10, bit: 13 },
];
